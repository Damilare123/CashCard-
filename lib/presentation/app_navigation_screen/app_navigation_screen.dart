...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
  ...
  onTapKwiki() {
    Get.toNamed(AppRoutes.kwikiScreen);
  }

  onTapKwiki1() {
    Get.toNamed(AppRoutes.kwiki1Screen);
  }
